...
echo "Copying NGINX binary to bin folder"
cp /tmp/nginx/sbin/nginx /app/src/heroku/bin/nginx-cedar-14

echo "Copy mimetype"
cp /tmp/nginx/conf/mime.types /app/src/heroku/config/mime.types
